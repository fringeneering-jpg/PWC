...
Heat in the medium does not simply diffuse at random. **Heat is the driver: it sets the direction of the wave, and it is drawn toward sources of untying** — a buoyancy-like pull, heat seeking the places where knots are releasing, rather than being pushed around by the flow. The medium is chiral (the paired EM(+)/EM(−) birefringent structure of §1, and the handed quicycle knot of §5), and in a chiral medium heat can travel as a **coherent directed wave** instead of spreading evenly. This is established physics in other systems: the **chiral heat wave**, driven by the mixed gauge-gravitational anomaly of quantum field theory (Chernodub et al., ~2015 onward), worked out for rotating quark-gluon plasma and Weyl semimetals; in magnetic fields or dense matter it mixes with the chiral magnetic and chiral vortical waves. Related directed heat transport is seen in **chiral phonons** (lattice vibrations carrying heat and angular momentum together, used for magnetically switched nanoscale thermal devices) and in **non-Hermitian thermal systems**, where heat moves with directional robustness near exceptional points.
