...
- **k-rule = universal held column density:** M_med = 0.869·C^(2/3) ⇔ Σ = M_med/4πR_c² = 8.48×10²⁰ kg/m² for every core (≈3.7 km of nuclear-density skin, or ≈650 km at ρ_max). Hydrostatic atmospheres fail (cores >~9 M☉ lie inside their own choke — medium there cannot be static); steady inflow of resting medium fails by ~39 orders (predictions/bh_flow_profile.md). So the held medium is made at the black hole (shredded/untied matter). Derive what fixes a universal column Σ at the core surface — NEEDS DERIVATION
