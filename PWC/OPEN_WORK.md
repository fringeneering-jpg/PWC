...
- Void shapes: evacuated voids round off with expansion (Icke 1984 "bubble theorem"); burnt voids keep the irregular footprint of their hot spots. Test: measured void ellipticity vs size/redshift against ΛCDM mock voids; PWC predicts no rounding trend. Also: does the elongated (symmetry-breaking) side border hotter web (Planck Compton-y)? — NEEDS TEST
