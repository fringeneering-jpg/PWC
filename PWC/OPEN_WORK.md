...
- **Only the medium chokes; matter is caught and shredded (Jaden):** infalling matter is not a sound wave in the medium — it is caught at the event horizon and shredded (knots broken at ρ_max, the medium cycle). If shredding happens at/inside the light horizon, whatever light the untying releases cannot escape — consistent with quiescent black-hole X-ray binaries showing no surface emission. v = √(2GM/r) is energy conservation outside the mass and is used only down to the choke, never continued to r → 0 — NEEDS DERIVATION
